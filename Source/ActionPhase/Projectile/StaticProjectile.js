function StaticProjectile (battle, x, y, angle) {
	var MAX_DISTANCE = 15;
	...
	var image = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Projectile/Static/Static.png");
	var image2 = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Projectile/Static/Spark.png");
	
	this.m_type = ENUM_PROJECTILE_STATIC;
	this.m_x = x;
	this.m_y = y;
	this.m_angle = angle;
	
	this.m_speed = g_bulletData[ENUM_PROJECTILE_STATIC].m_speed;
	this.m_damage = g_bulletData[ENUM_PROJECTILE_STATIC].m_damage;
	this.m_armorPierce = g_bulletData[ENUM_PROJECTILE_STATIC].m_armorPierce;
	this.m_areaOfEffect = g_bulletData[ENUM_PROJECTILE_STATIC].m_areaOfEffect;

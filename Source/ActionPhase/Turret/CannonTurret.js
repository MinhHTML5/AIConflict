function CannonTurret (battle, x, y) {
	...
	var baseImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Cannon/Base.png");
	var shadowImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Cannon/Shadow.png");
	var turretImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Cannon/Turret.png");
	
	this.m_type = ENUM_TURRET_CANNON;
	this.m_blockX = x;
	this.m_blockY = y;
	...
	this.m_name = g_turretData[ENUM_TURRET_CANNON].m_name;
	this.m_range = g_turretData[ENUM_TURRET_CANNON].m_range;
	this.m_rotateSpeed = g_turretData[ENUM_TURRET_CANNON].m_rotateSpeed;
	this.m_rateOfFire = g_turretData[ENUM_TURRET_CANNON].m_rateOfFire;
	this.m_ammoCost = g_turretData[ENUM_TURRET_CANNON].m_ammoCost;
	this.m_energyCost = g_turretData[ENUM_TURRET_CANNON].m_energyCost;
	...
	this.Attack = function () {
		if (rateOfFireCount <= 0) {
			if (battle.m_ammunition >= this.m_ammoCost && battle.m_energy >= this.m_energyCost) {
				...
				var temp = new CannonProjectile (battle, this.m_x, this.m_y, this.m_angle);
	...
	this.SpecialAttack = function () {
		if (rateOfFireCount <= 0) {
			if (battle.m_ammunition >= this.m_ammoCost && battle.m_energy >= this.m_energyCost) {
				...
				var temp = new PenetrationProjectile (battle, this.m_x, this.m_y, this.m_angle);
				this.bullet.push (temp);

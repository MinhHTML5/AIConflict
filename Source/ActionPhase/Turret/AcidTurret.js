function AcidTurret (battle, x, y) {
	...
	var baseImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Acid/Base.png");
	var shadowImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Acid/Shadow.png");
	var turretImage = g_graphicEngine.LoadImage(ROOT_FOLDER + "Image/ActionPhase/Turret/Acid/Turret.png");
	
	
	this.m_type = ENUM_TURRET_ACID;
	this.m_blockX = x;
	this.m_blockY = y;
	...
	this.m_name = g_turretData[ENUM_TURRET_ACID].m_name;
	this.m_range = g_turretData[ENUM_TURRET_ACID].m_range;
	this.m_rotateSpeed = g_turretData[ENUM_TURRET_ACID].m_rotateSpeed;
	this.m_rateOfFire = g_turretData[ENUM_TURRET_ACID].m_rateOfFire;
	this.m_ammoCost = g_turretData[ENUM_TURRET_ACID].m_ammoCost;
	this.m_energyCost = g_turretData[ENUM_TURRET_ACID].m_energyCost;
	...
	g_spraySoundNode.SetCameraHandler (battle.camera);
	...
	this.Attack = function () {
		if (rateOfFireCount <= 0) {
			if (battle.m_ammunition >= this.m_ammoCost && battle.m_energy >= this.m_energyCost) {
				...
				var temp;
				temp = new AcidProjectile (battle, this.m_x, this.m_y, this.m_angle - 15);
				this.bullet.push (temp);
				temp = new AcidProjectile (battle, this.m_x, this.m_y, this.m_angle - 7);
				this.bullet.push (temp);
				temp = new AcidProjectile (battle, this.m_x, this.m_y, this.m_angle - 0);
				this.bullet.push (temp);
				temp = new AcidProjectile (battle, this.m_x, this.m_y, this.m_angle + 7);
				this.bullet.push (temp);
				temp = new AcidProjectile (battle, this.m_x, this.m_y, this.m_angle + 15);
				...
				g_spraySoundNode.Play(this.m_x, this.m_y);
			}
		}
	}
	...
	this.SpecialAttack = function () {
		if (rateOfFireCount <= 0) {
			if (battle.m_ammunition >= this.m_ammoCost && battle.m_energy >= this.m_energyCost) {
				...
				var temp;
				temp = new LiquidExplosiveProjectile (battle, this.m_x, this.m_y, this.m_angle - 15);
				this.bullet.push (temp);
				temp = new LiquidExplosiveProjectile (battle, this.m_x, this.m_y, this.m_angle - 7);
				this.bullet.push (temp);
				temp = new LiquidExplosiveProjectile (battle, this.m_x, this.m_y, this.m_angle - 0);
				this.bullet.push (temp);
				temp = new LiquidExplosiveProjectile (battle, this.m_x, this.m_y, this.m_angle + 7);
				this.bullet.push (temp);
				temp = new LiquidExplosiveProjectile (battle, this.m_x, this.m_y, this.m_angle + 15);
